  ...
  opts = {
    ...
    highlights = {
      init = { -- this table overrides highlights in all themes
        ...
        NormalSB = { bg = "none" },
        FloatBorder = { bg = "none" },
        FloatTitle = { bg = "none" },--FloatTitle = { fg = "#F2F3F5", bg = "none" },
        -- WinBar
        WinBar = { bg = "none" },
        WinSeparator = { bg = "none" },--WinSeparator = { fg = "#F2F3F5", bg = "none" },
        WinBarNC = { bg = "none" },
        WhichKeyFloat = { bg = "none" },
        -- Telescope
        TelescopeBorder = { bg = "none" },
        ...
        --StatusLineTermNC = { fg = "#F2F3F5", bg = "none" },
        --VertSplit = { fg = "#F2F3F5", bg = "none" },
        StatusLine = { bg = "none" }, -- Nome do documento aberto na barra inferior
        ...
        TabLine = { bg = "none" },
        TabLineSel = { bg = "none" },
        TabLineFill = { bg = "none" }, -- Texto do título nas abas acima
        -- Cursor
        LineNr = { fg = "#666666", bg = "none" },
        CursorLineNr = { bg = "none" },
        CursorLine = { bg = "none" }, -- Cor do texto da linha q o cursor está
        ColorColumn = { bg = "none" },
        -- Search
        Search = { fg = "red" },
        IncSearch = { fg = "red" },
